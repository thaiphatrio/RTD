...
_0x0:
	.DB  0x20,0x6E,0x20,0x3D,0x20,0x25,0x64,0x2C
	.DB  0x20,0x54,0x20,0x3D,0x20,0x25,0x30,0x2E
	.DB  0x32,0x66,0x25,0x63,0x43,0x2C,0x20,0x56
	.DB  0x20,0x3D,0x20,0x25,0x30,0x2E,0x32,0x66
	.DB  0xD,0xA,0x0
_0x2000000:
...
; 0000 0035 
; 0000 0036     int ADC_val;
; 0000 0037     float alpha;
; 0000 0038     float T, Voltage;
; 0000 0039 
...
; 0000 0050 TCCR0=(0<<CS02) | (0<<CS01) | (0<<CS00);
	OUT  0x33,R30
...
; 0000 0075 TIMSK=(0<<OCIE2) | (0<<TOIE2) | (0<<TICIE1) | (0<<OCIE1A) | (0<<OCIE1B) | (0<<TOIE1) | (0<<TOIE0);
	OUT  0x39,R30
; 0000 0076 
...
; 0000 0082 UCSRA=(0<<RXC) | (0<<TXC) | (0<<UDRE) | (0<<FE) | (0<<DOR) | (0<<UPE) | (0<<U2X) | (0<<MPCM);
	OUT  0xB,R30
; 0000 0083 UCSRB=(0<<RXCIE) | (0<<TXCIE) | (0<<UDRIE) | (0<<RXEN) | (1<<TXEN) | (0<<UCSZ2) | (0<<RXB8) | (0<<TXB8);
	LDI  R30,LOW(8)
	OUT  0xA,R30
...
; 0000 0093 ADMUX=ADC_VREF_TYPE;
	LDI  R30,LOW(0)
	OUT  0x7,R30
; 0000 0094 ADCSRA=(1<<ADEN) | (0<<ADSC) | (0<<ADFR) | (0<<ADIF) | (0<<ADIE) | (1<<ADPS2) | (0<<ADPS1) | (0<<ADPS0);
	LDI  R30,LOW(132)
	OUT  0x6,R30
...
; 0000 00A2       ADC_val = read_adc(6);
	LDI  R26,LOW(6)
	RCALL _read_adc
	MOVW R16,R30
; 0000 00A3       Voltage = (float)ADC_val/1023.0;
	RCALL SUBOPT_0x0
	MOVW R26,R30
	MOVW R24,R22
	__GETD1N 0x447FC000
	...
	RCALL SUBOPT_0x1
; 0000 00A4 
; 0000 00A5       T =  (float)(ADC_val - 512)*alpha;
	MOVW R30,R16
	SUBI R30,LOW(512)
	SBCI R31,HIGH(512)
	RCALL SUBOPT_0x0
	__GETD2S 8
	RCALL SUBOPT_0x2
; 0000 00A6       printf(" n = %d, T = %0.2f%cC, V = %0.2f\r\n", ADC_val, T,176, Voltage);
	__POINTW1FN _0x0,0
	RCALL SUBOPT_0x3
	MOVW R30,R16
	RCALL __CWD1
